...
import { __unstableSerializeAndClean, SerializeAndClean as stableSerializeAndClean } from '@wordpress/blocks'
import { useEntityProp, useEntityBlockEditor } from '@wordpress/core-data'
import { count as wordCount } from '@wordpress/wordcount'

const serializeAndClean = __unstableSerializeAndClean || stableSerializeAndClean
/**
...
function PostTimeToReadEdit ({ attributes, setAttributes, context }) {
  ...
  const minutesToReadString = useMemo(() => {
    ...
    if (contentStructure instanceof Function) {
      ...
      content = serializeAndClean(blocks)
    } else {
